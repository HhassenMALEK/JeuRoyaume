...
public class GestionMissions {
    ...
    public GestionMissions(GestionRessources gestionRessources, GestionCitoyens gestionCitoyens, MongoDatabase database) {
    ...
    public boolean preparerMission(String nomMission, int soldatsNecessaires, int boisNecessaire, int nourritureNecessaire) {
        ...
        boolean boisSuffisant = gestionRessources.verifierRessources("Bois", boisNecessaire);
        boolean nourritureSuffisante = gestionRessources.verifierRessources("Nourriture", nourritureNecessaire);
    ...
    public void calculerGainMission(String nomMission, boolean missionReussie, int soldatsEnvoyes) {
        if (missionReussie) {
